...
import { 
  ...
  MessageSquareText, Menu, X, Building2, HelpCircle, MapPin, Layers, ShieldCheck, Shield, History, Zap, Archive
} from 'lucide-react';
...
const allNavItems = [
  ...
  { path: '/archives', icon: Archive, label: 'Archives', help: 'Restaurer un état antérieur de l\'organigramme', roles: ['admin', 'rh'] },
